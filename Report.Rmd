...
<strong>Danceability</strong> (β=0.098, p\<0.001): Songs with higher danceability scores were more likely to be popular, with a small but significant positive effect.

<strong>Energy</strong> (β=−0.230, p\<0.001): Higher energy levels were associated with lower popularity.

<strong>Loudness</strong> (β=1.305, p\<0.001): Louder songs were more likely to be more popular.

<strong>Acousticness</strong> (β=5.250, p\<0.001): More acoustic songs were more likely to be more popular.

<strong>Instrumentalness</strong> (β=−6.222, p\<0.001): Instrumental tracks are less likely to be popular.

<h4>Playlist Genre</h4>

<strong>Pop</strong> (β=12.468, p\<0.001) and <strong>Rock</strong> (β=11.025, p\<0.001) genres showed the strongest positive associations with popularity.

Other genres such as <strong>Latin</strong> (β=7.822, p\<0.001) and <strong>Rap</strong> (β=7.469, p\<0.001) also had notable positive effects.
